    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link" href="<%= request.getContextPath()+"/Form" %>">Form</a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link disabled" href="<%= request.getContextPath()+"/Test" %>" tabindex="-1" aria-disabled="true">Disabled</a>
        </li>
      </ul>
      <form class="d-flex">
